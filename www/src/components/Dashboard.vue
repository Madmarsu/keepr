<template>
    <div class="container">
        <ul class="pagination">
            <li :class="{ active: showVaults, 'waves-effect': showKeeps }"><a @click="activateVaults">V</a></li>
            <li :class="{ active: showKeeps, 'waves-effect': showVaults }"><a @click="activateKeeps">K</a></li>
        </ul>
        ...
        <div v-show="showKeeps">
            <h4 class="center">My Keeps
                <router-link to="/keeps" class="btn-floating btn right blue darken-4 hoverable"><i class="fa fa-plus"></i></router-link>
            </h4>
            <div class="row">
